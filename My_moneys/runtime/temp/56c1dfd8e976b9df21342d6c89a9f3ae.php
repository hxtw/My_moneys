<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\PHPTutorial\WWW\My_moneys\public/../application/index\view\Video\list.html";i:1557404532;}*/ ?>
<!--易企秀投稿 记录-->
...
<script>
    ...
    function a_hear(type,id) {
        $('#content-load').load( "<?php echo url("Index/Video/edit_index"); ?>" + "?id=" + id );
    }
</script>