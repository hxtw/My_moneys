<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\My_moneys\public/../application/index\view\Article\list.html";i:1557469300;}*/ ?>
<!--视频 记录-->
...
<script>
    ...
    function a_hear(type,id) {
        $('#content-load').load( "<?php echo url("Index/Article/edit_index"); ?>" + "?id=" + id );
    }
</script>