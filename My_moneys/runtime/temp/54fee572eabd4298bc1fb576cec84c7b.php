<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\PHPTutorial\WWW\My_moneys\public/../application/index\view\Index\index.html";i:1557742945;}*/ ?>
<!doctype html>
<html lang="en">
...
<head>
	...
	<!-- VENDOR CSS -->
	<link rel="stylesheet" href="/My_moneys/public/static/assets/vendor/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="/My_moneys/public/static/assets/vendor/font-awesome/css/font-awesome.min.css">
	<link rel="stylesheet" href="/My_moneys/public/static/assets/vendor/linearicons/style.css">
	<link href="/My_moneys/public/static/video_file/css/fileinput.css" media="all" rel="stylesheet" type="text/css"/>
<!--	<link rel="stylesheet" href="/My_moneys/public/static/assets/vendor/fileinput/bootstrap-fileinput.css">-->
	<!-- MAIN CSS -->
	<link rel="stylesheet" href="/My_moneys/public/static/assets/css/main.css">
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="/My_moneys/public/static/assets/img/apple-icon.png">
	<link rel="icon" type="image/png" sizes="96x96" href="/My_moneys/public/static/assets/img/favicon.png">
</head>
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="javascript:void(0);"><img src="/My_moneys/public/static/assets/img/logo-dark.png" alt="My money" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown"><img src="/My_moneys/public/static/assets/img/user.png" class="img-circle" alt="Avatar"> <span><?php echo \think\Cookie::get('my_money_user'); ?>
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="navDub" class="collapse">
								<ul class="nav">
									<li><a href="javascript:void(0);" class="" data-href="<?php echo url('index/Dubbing/add_index'); ?>"><i class="lnr lnr-alarm"></i> <span>来单了</span></a></li>
...
<!--	<script src="/My_moneys/public/static/assets/vendor/jquery/jquery.min.js"></script>-->
	<script src="/My_moneys/public/static/assets/vendor/jquery/jquery-3.3.1.min.js"></script>
	<script src="/My_moneys/public/static/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script src="/My_moneys/public/static/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!--	<script src="/My_moneys/public/static/assets/vendor/fileinput/bootstrap-fileinput.js"></script>-->
	<script src="/My_moneys/public/static/video_file/js/fileinput.js" type="text/javascript"></script>
	<script src="/My_moneys/public/static/video_file/js/locales/zh.js" type="text/javascript"></script>
	<script src="/My_moneys/public/static/assets/scripts/klorofil-common.js"></script>
	<script src="/My_moneys/public/static/layer/layer.js"></script>
	<script>
        jQuery(function($) {
