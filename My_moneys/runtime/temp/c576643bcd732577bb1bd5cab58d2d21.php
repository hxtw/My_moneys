<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\phpStudy\PHPTutorial\WWW\My_moneys\public/../application/index\view\Video\add_index.html";i:1557554948;}*/ ?>
<!--视频投稿-->
...
<!--                                大图上传-->
                        ...
                        <div class="form-group">
                            <input id="file-0a" class="file" type="file"   name="file1"  accept="video/*">
                        </div>
...
/*    视频上传功能 -配置        */
    $("#file-0a").fileinput({
        ...
        uploadUrl : "<?php echo url('index/Video/add_viadd'); ?>", //上传地址
        language : "zh",//语言
