<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\My_moneys\public/../application/index\view\Dubbing\list.html";i:1557472155;}*/ ?>
<!--配音记录-->
<div class="container-fluid">
    <h3 class="page-title">配音记录</h3>
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                                <?php if(is_array($du_list) || $du_list instanceof \think\Collection || $du_list instanceof \think\Paginator): $i = 0; $__LIST__ = $du_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
...
<script>
    function whereFrom(where_id) {
        $('#content-load').load( "<?php echo url("Index/Dubbing/list_index"); ?>" + "?where=" + where_id );
    }

    function a_hear(type,id) {
        $('#content-load').load( "<?php echo url("Index/Dubbing/edit_index"); ?>" + "?id=" + id );
    }
</script>