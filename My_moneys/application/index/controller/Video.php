...
class Video extends Controller
{
    ...
    */
    public function list_index()
    {
        ...
        //查询易企秀的列表数据
        $vde_list = Db::name('video')->field('vde_id as id,vde_title as title,vde_isstate as isstate')->where($vde_list_where)->select();
        //模板输出
...
//            'vde_id' =>$request->post('id','','trim,htmlspecialchars,addslashes'),
            ...
            'vde_simg' => str_replace("\\\\","/",$simg),
            'vde_himg' => str_replace("\\\\","/",$himg),
    ...
    */
    public function edit_index()
    {
        ...
        //where参数，sql语句
        $vdo_where['vde_id']=$request->get('id','','trim');
